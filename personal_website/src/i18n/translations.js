      ...
      items: [
        {
          ...
          description:
            "Product & UX/UI design for Kinalia, an AI consulting studio I co-founded with friends. Designed and built the marketing site, from messaging to visual identity.",
        ...
        },
        {
          ...
          type: "dev",
          title: "Rope Master",
          subtitle: "Kinalia · Next.js + Tailwind",
          description:
            "Product & UX/UI design for Kinalia's first product: an offline-first event management system for roping competitions. Designed the landing page — series, events, and results sync in real time with zero dependency on signal.",
          tags: ["Next.js", "React", "Tailwind CSS", "UI/UX Design", "Product Design"],
          github: "https://github.com/AnaEstrada-05/Kinalia.git",
          figma: null,
          live: "https://kinalia.com.mx/es/productos/ropemaster",
          gradient: "linear-gradient(135deg, #1a1005 0%, #3d2410 40%, #7a3f0f 70%, #c2650a 100%)",
          accentColor: "#f97316",
        },
        {
          index: "03",
        ...
        },
        {
          ...
          subtitle: "UX/UI Design · Figma",
          description:
            "UI/UX design for a jewelry e-commerce brand. Designed interactive catalog and store interfaces optimizing visual hierarchy, conversion, and purchase flow, with a clean, elegant visual identity across every touchpoint.",
          tags: ["Figma", "E-commerce", "UI Design", "Design System"],
          github: null,
          figma: "https://www.figma.com/design/wTX0pLioYxx9IzNXNMAXLh/Untitled?node-id=8-2&p=f&t=v3nbKvxI7rQGTuaF-0",
        ...
        },
        {
          ...
          live: "https://www.emprendemos.org/",
      ...
      items: [
        {
          ...
          description:
            "Diseño de producto y UX/UI para Kinalia, un estudio de consultoría de IA que cofundé con amigos. Diseñé y construí el sitio principal, desde el mensaje hasta la identidad visual.",
        ...
        },
        {
          ...
          subtitle: "Kinalia · Next.js + Tailwind",
          description:
            "Diseño de producto y UX/UI para el primer producto de Kinalia: un sistema de gestión de eventos de lazo que funciona sin internet. Diseñé la landing page — series, eventos y resultados sincronizados en tiempo real, sin depender de señal.",
          tags: ["Next.js", "React", "Tailwind CSS", "UI/UX Design", "Diseño de producto"],
          github: "https://github.com/AnaEstrada-05/Kinalia.git",
          figma: null,
          live: "https://kinalia.com.mx/es/productos/ropemaster",
        ...
        },
        {
          ...
          subtitle: "UX/UI Design · Figma",
          description:
            "Diseño UI/UX para una marca de e-commerce de joyería. Diseñé interfaces de catálogo y tienda interactiva optimizando la jerarquía visual, la conversión y el flujo de compra, con una identidad visual limpia y elegante en todos los puntos de contacto.",
          tags: ["Figma", "E-commerce", "UI Design", "Sistema de diseño"],
          github: null,
          figma: "https://www.figma.com/design/wTX0pLioYxx9IzNXNMAXLh/Untitled?node-id=8-2&p=f&t=v3nbKvxI7rQGTuaF-0",
          gradient: "linear-gradient(135deg, #1c1611 0%, #3d2f1f 40%, #6b4f2e 70%, #a67c3d 100%)",
          accentColor: "#d4af37",
